...
#define MAX_APPLICATION_SPEED_RPM       5460 /*!< rpm, mechanical */
...
#define PID_SPEED_KP_DEFAULT          3845/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          3872/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
