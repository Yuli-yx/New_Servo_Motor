...
#define RS                     1.77 /* Stator resistance , ohm*/
...
#define NOMINAL_CURRENT         823
#define MOTOR_MAX_SPEED_RPM     5460 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  1.4 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -823 /*!< Demagnetization current */
...
#define HALL_PHASE_SHIFT        65 /*!< Define here in degrees
